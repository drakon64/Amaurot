...
namespace Amaurot.Client.GitHub.Models
{
    ...
    internal partial class ReactionRollup : IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Amaurot.Client.GitHub.Models.ReactionRollup"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Amaurot.Client.GitHub.Models.ReactionRollup CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Amaurot.Client.GitHub.Models.ReactionRollup();
        }
        /// <summary>
