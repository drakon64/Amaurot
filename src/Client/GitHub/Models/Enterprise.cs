...
namespace Amaurot.Client.GitHub.Models
{
    ...
    internal partial class Enterprise : IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Amaurot.Client.GitHub.Models.Enterprise"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Amaurot.Client.GitHub.Models.Enterprise CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Amaurot.Client.GitHub.Models.Enterprise();
        }
        /// <summary>
